...
public class ViewProductDetailJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(btnUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 340, 176, -1));
        ...
        add(btnSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 340, 70, 30));

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel4.setText("Product Target Price:");
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 170, 180, 30));

        targetPriceTxtField.setEditable(false);
        targetPriceTxtField.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        add(targetPriceTxtField, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 170, 160, 30));

        jLabel6.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel6.setText("Product Ceil Price:");
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 210, 160, 30));

        ceilPriceTxtField.setEditable(false);
        ceilPriceTxtField.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        add(ceilPriceTxtField, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 210, 160, 30));

        jLabel7.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel7.setText("Product Floor Price:");
        add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 260, 170, 30));

        floorPriceTxtField.setEditable(false);
        floorPriceTxtField.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        add(floorPriceTxtField, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 260, 160, 30));

        jLabel8.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel8.setText("Product Availability:");
        add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 300, 170, 30));

        availTxtField.setEditable(false);
        availTxtField.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        add(availTxtField, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 300, 160, 30));
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        floorPriceTxtField.setEditable(true);
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        product.setFloorPrice(Integer.parseInt(floorPriceTxtField.getText()));
