...
public class ManageEmployeePanel extends javax.swing.JPanel {
    ...
    private void populateTable(Organization organization){
        ...
        for (Traveller traveller : organization.getTravellerDirectory().getTravellerList()){
            ...
            row[0] = traveller.getId();
            row[1] = traveller.getName();
            model.addRow(row);
        }
    }
    /**
    ...
    private void addJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addJButtonActionPerformed
        if(nameJTextField.getText().equals("")){
            JOptionPane.showMessageDialog(null, "Enter a name and then click here!");
        }
        else{
        String name = nameJTextField.getText();   
        Organization organization = (Organization) organizationEmpJComboBox.getSelectedItem();
        organization.getTravellerDirectory().createTraveller(name,organization);
