...
import Business.Role.TravelSeekerRole;
...
public class ManageUserAccountPanel extends javax.swing.JPanel {
    ...
    public void populateEmployeeComboBox(Organization organization){
        ...
        for (Traveller employee : organization.getTravellerDirectory().getTravellerList()){
    ...
    private void populateRoleComboBox(Organization organization){
      ...
      ArrayList<Role> role = organization.getSupportedRole();
      ...
      else if(organization.getName().equals(Organization.Type.CarOwner.getValue())){
          role.add(new CarOwnerRole());
          for (Role r : organization.getSupportedRole()){
          roleJComboBox.addItem(r);
      }
      }
      else if(organization.getName().equals(Organization.Type.TravelSeeker.getValue())){
          role.add(new TravelSeekerRole());
          for (Role r : organization.getSupportedRole()){
          roleJComboBox.addItem(r);
      }
    ...
    private void createUserJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createUserJButtonActionPerformed
        ...
        Traveller employee = (Traveller) employeeJComboBox.getSelectedItem();
        Role role = (Role) roleJComboBox.getSelectedItem();
        
        for(Organization org : enterprise.getOrganizationDirectory().getOrganizationList()){
        for(UserAccount userAccount : org.getUserAccountDirectory().getUserAccountList()){
            if(userAccount.getUsername().equals(userName)){
                JOptionPane.showMessageDialog(null, "The username already exists, use another username.");
                return;
            }
        }
        }
