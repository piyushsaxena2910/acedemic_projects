 ...
 * @author Piyush
 */
public class ManageEnterpriseAdmnJPanel extends javax.swing.JPanel {
     ...
     */
    public ManageEnterpriseAdmnJPanel(JPanel userProcessContainer, EcoSystem system) {
        initComponents();
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        for(Traveller traveller : enterprise.getTravellerDirectory().getTravellerList()){
            if(traveller.getName().equals(name)){
                JOptionPane.showMessageDialog(null, "Account already create for this user.");
                return;
            }
        }
        Traveller traveller = enterprise.getTravellerDirectory().createTraveller(name,null);
        ...
        UserAccount account = enterprise.getUserAccountDirectory().createUserAccount(username, password, traveller, new AdminRole());
        }
        populateTable();
        }
