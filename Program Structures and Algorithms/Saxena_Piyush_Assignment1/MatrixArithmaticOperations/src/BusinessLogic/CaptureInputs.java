...
public class CaptureInputs {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("If you want to perform Matrix Addition then Enter 1");
        System.out.println("If you want to perform Matrix Sumbtraction then Enter 2");
        System.out.println("If you want to perform Matrix Multiplication then Enter 3");
        ...
        if(!(operation == 1 || operation == 2 || operation == 3)){
            ...
            switch(operationToPerform){
                case "1":
                    PerformAddition pa = new PerformAddition();
                    //pa.addition(matrix1, matrix2, n1, m1);
                    break;
                case "2":
                    PerformSubtraction ps = new PerformSubtraction();
                    //ps.subtraction(matrix1, matrix2, n1, m1);
                    break;
                case "3":
                    if(!(m1==n2)){
                    ...
                    pm.multiplication(matrix1, matrix2, n1, m1, n2, m2);
                    }
                    break;
            }
        }
